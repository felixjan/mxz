package com.mxz.admin.cms.customer.controller;
...
public class CmsCustomerController {
	 ...
	 @Autowired 
	 private CmsCustomerService service; 
	 ...
	 public CmsCustomer getById(@PathVariable String id) {
	 ...
	 public List<CmsCustomer> getList(@RequestBody(required=false) Map<String,Object> paramMap) {
